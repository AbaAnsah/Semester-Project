...
public:
    Account(string number = "ABA ANSAH", string holder = "123456789", double initialBalance = 5000.0)
...
int main() {
    Account userAccount("ABA ANSAH", "UEB3262922", 5000.0);
        ...
        switch (choice) {
            ...
            case 3:
                // Buy stocks
                {
                    ...
                    cin >> stockQuantity;
                    Stock stockToBuy(stockSymbol, "BEAUTY PARLOUR", 150.0); // Replace with actual stock details
            ...
            case 4:
                // Sell stocks
                {
                    ...
                    Stock stockToSell(stockSymbolSell, "BEAUTY PARLOUR", 150.0); // Replace with actual stock details
